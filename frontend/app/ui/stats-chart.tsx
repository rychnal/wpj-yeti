...
export default function StatsChart({ data }: { data: MonthlyStat[] }) {
        ...
        return (
          ...
          >
            ...
            <div
              ...
              title={`${MONTHS[d.month - 1]} ${d.year}: ${d.total_ratings} hodnocení, průměr ${Number(d.avg_score).toFixed(1)}`}
            />
            <span className="text-zinc-400 text-xs truncate w-full text-center">
              {MONTHS[d.month - 1]}
            </span>
          </div>
        )
